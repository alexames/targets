...
function(cpp_target)
  ...
  cmake_path(IS_RELATIVE args_SOURCE_DIR is_relative)
  if(is_relative)
  ...
  cmake_path(IS_RELATIVE args_HEADER_DIR is_relative)
  if(is_relative)
  ...
  # Gather source files with absolute paths
  unset(sources)
  ...
  # Gather header files with absolute paths
  unset(headers)
